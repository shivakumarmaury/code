let cards = document.querySelectorAll('.grid_tabs');
let lists = document.querySelectorAll(".grid_two_box");
...
function getCardAfterDraggingCard(list, yDraggingCard){
	let listCards = [...list.querySelectorAll('.grid_tabs:not(.dragging)')]; 
